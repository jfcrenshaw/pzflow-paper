"""Calculate photometric errors using the LSST Error Model.

See the docstring below for details.
"""
...
class LSSTErrorModel:
    ...
    def __init__(
        ...
        """Error model from the LSST Overview Paper: https://arxiv.org/abs/0805.2366
        ...
        By default, the LSST bands are named "u", "g", "r", "i", "z", and "y".
        You can use the bandNames dictionary to alias them differently.

        For example, if in your DataFrame, the bands are named lsst_u, lsst_g, etc.
        you can set bandNames = {"u": "lsst_u", "g": "lsst_g", ...}, and the error
        model will work automatically.
    ...
    def default_settings(self) -> dict:
        """Return default settings for the error model.

        All of these values come from the LSST Overview Paper,
        https://arxiv.org/abs/0805.2366
